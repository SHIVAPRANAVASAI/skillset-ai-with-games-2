  ...
  const games = [
    {
      ...
      description: 'Program and simulate microcontrollers in a virtual environment',
      icon: '🖥️',
      level: 'advanced',
      path: '/games/embedded/microcontroller-lab',
      gradient: 'linear-gradient(135deg, #00979D 0%, #00D4FF 100%)',
      accentColor: '#00979D'
    },
    {
      title: 'IoT Simulator',
    ...
    },
    {
      ...
      icon: '⚡',
      level: 'advanced',
      path: '/games/embedded/rtos-explorer',
  ...
  return (
    <div className="category-page">
      ...
      <div className="category-header">
        ...
        <p>Microcontroller and embedded systems games</p>
      </div>
