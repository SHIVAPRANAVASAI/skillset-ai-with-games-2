...
function Community() {
  const whatsappGroups = {
    programming: 'https://chat.whatsapp.com/DdaZlXO0OXjLgexL4BSEeU',
    project: 'https://chat.whatsapp.com/FIa0Xg6DBiD4vTuX3IrhsF',
    career: 'https://chat.whatsapp.com/Hgj22aiGYIg5r9o0HKJoEs'
  };
            ...
            <div className="forum-topics">
              <div className="topic-card">
                ...
                <button 
                  ...
                  onClick={() => handleJoinGroup(whatsappGroups.programming)}
                >
                  Join WhatsApp Group
                </button>
              </div>
              ...
              <div className="topic-card">
                ...
                <button 
                  className="join-button"
                  onClick={() => handleJoinGroup(whatsappGroups.project)}
                >
                  Join WhatsApp Group
                </button>
              </div>
              ...
              <div className="topic-card">
                ...
                <button 
                  className="join-button"
                  onClick={() => handleJoinGroup(whatsappGroups.career)}
                >
                  Join WhatsApp Group
                </button>
              </div>
